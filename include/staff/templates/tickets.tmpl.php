...
$tickets->values('staff_id', 'staff__firstname', 'staff__lastname', 'team__name', 'team_id', 'lock__lock_id', 'lock__staff_id', 'isoverdue', 'status_id', 'status__name', 'status__state', 'number', 'cdata__subject','cdata__subject_1', 'ticket_id', 'source', 'dept_id', 'dept__name', 'user_id', 'user__default_email__address', 'user__name', 'lastupdate');
...
<?php csrf_token(); ?>
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="2" width="940">
    ...
    foreach($tickets as $T) {
        ...
        $tid = $T['number'];
$subject = $subject_field->display($subject_field->to_php($T['cdata__subject'] ?: $T['cdata__subject_1']));
