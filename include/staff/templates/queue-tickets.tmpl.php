...
$tickets->values(
    'cdata__subject',
    'cdata__subject_1', 'cdata__subject_2', 'cdata__subject_3', 'cdata__subject_4', 'cdata__subject_5',
    'cdata__subject_6', 'cdata__subject_7', 'cdata__subject_8', 'cdata__subject_9', 'cdata__subject_10',
    'cdata__subject_11', 'cdata__subject_12', 'cdata__subject_13', 'cdata__subject_14', 'cdata__subject_15',
    'cdata__subject_16', 'cdata__subject_17', 'cdata__subject_18', 'cdata__subject_19'
);
...
foreach ($columns as $C) {
    ...
    // Vérifie si c'est la colonne "Subject"
if (strpos(strtolower($C->getLocalHeading()), 'subject') !== false) {
   $subjects = [];
for ($i = 0; $i <= 19; $i++) {
    $key = $i === 0 ? 'cdata__subject' : 'cdata__subject_' . $i;
    if (!empty($T[$key]))
        $subjects[] = Format::htmlchars($T[$key]);
}
$contents = implode('<br>', $subjects);
}
