...
$tickets->values(
    ...
    'status__state', 'status__name', 'cdata__subject', 'cdata__subject_1','cdata__subject_2','cdata__subject_3', 'cdata__subject_4', 'cdata__subject_5',
'cdata__subject_6', 'cdata__subject_7', 'cdata__subject_8',
'cdata__subject_9', 'cdata__subject_10', 'cdata__subject_11',
'cdata__subject_12', 'cdata__subject_13','cdata__subject_14', 'cdata__subject_15', 'cdata__subject_16',
'cdata__subject_17', 'cdata__subject_18','cdata__subject_19',
    'dept_id', 'dept__name', 'dept__ispublic',
    'user__default_email__address', 'user_id'
);
?>
...
<table id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  $subject_parts = [];
for ($i = 0; $i <= 19; $i++) {
    $key = $i === 0 ? 'cdata__subject' : 'cdata__subject_' . $i;
    if (!empty($T[$key]))
        $subject_parts[] = Format::htmlchars($T[$key]);
}
$subject = implode('<br>', $subject_parts);
